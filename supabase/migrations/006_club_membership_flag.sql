ALTER TABLE athletes ADD COLUMN is_club_member BOOLEAN NOT NULL DEFAULT false;

-- Leaderboard should only show current club members
...
BEGIN
  ...
  WHERE a.is_club_member = true
    AND act.start_date >= date_filter
